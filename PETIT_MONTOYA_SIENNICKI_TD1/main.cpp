...
void menu()
{
    ...
    do
    {
        ...
        std::cout<<"5.          extension ligne de bus de l'Ile d'oleron"<<std::endl;
        std::cin>>choix0;

    }
    while(choix0>5 || choix0<1);
    ...
    case 4 :
        ...
        break;
    case 5 :
        nom_fich="IleDOleron_topologie.txt";
        break;
    }


        Graphe G(nom_fich, choix0);
    ...
    while (choix!=1)
    {
        ...
        if(choix == 2)
        {
            ...
            case 4 :
                ...
                case 5:
                pond="IleDOleron_ponderation.txt";
                break;
            }
        ...
        Svgfile svg;
        svg.addGrid();
        G.afficher_gr(svg, choix, choix0);
    }
